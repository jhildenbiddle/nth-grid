        ...
        if (grid.columns_unit.length > 0) {
            grid.columns.forEach(function(columnVal, i) {
                ...
                if (columnVal !== grid.total_ratio_columns) {
                    var nthCol = i > grid.columns.indexOf(grid.total_ratio_columns) ? i + grid.total_ratio_columns : i + 1;
        ...
        grid.columns.forEach(function(columnVal, i) {
            ...
            if (Number(columnVal)) {
                ...
                // Calc() not required
                    ...
                    var columnWidth = round(unitMath([grid.grid_col_width, columnVal], ' * '));
